<template>
  <div v-if="!winePosted" class="q-pa-md" style="max-width: 400px">
    <q-card>
      <q-toggle v-model="nameToggle" :label="nameToggle" true-value="I know the wine's name" false-value="I don't know the wine's name" />
      <q-toggle v-model="vintageToggle" :label="vintageToggle" true-value="I know the wine's vintage" false-value="I don't know the wine's vintage" />
      <q-toggle v-model="varietalToggle" :label="varietalToggle" true-value="I know the wine's varietal" false-value="I don't know the wine's varietal" />
    </q-card>
    <q-form @submit="submitHandler" class="q-gutter-md">
      <q-input v-if="nameToggle === `I know the wine's name`" filled v-model="wine_name" label="Wine Name" hint="What does it say on the bottle?" />
      <q-input v-if="vintageToggle === `I know the wine's vintage`"
        filled
        v-model="vintage"
        label="Vintage"
      ...
      <q-input v-if="varietalToggle === `I know the wine's varietal`" filled v-model="varietal" label="Varietal" hint="Cabernet, Chardonnay, etc." />
